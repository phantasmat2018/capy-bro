...
- **Історія покращень** (за замовчуванням увімкнено з v14):
  зберігає оригінал / результат / промт / модель / час останніх 50 запусків. Пошук + копіювання назад / Undo з будь-якого запису. Можна вимкнути в Налаштуваннях → Додаткові функції. Файл `~/.ai_text_improver_v2_history.json`.
